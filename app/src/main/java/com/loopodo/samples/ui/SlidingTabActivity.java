package com.loopodo.samples.ui;
...
import com.loopodo.gradienttablayout.SlidingTabLayout;
import com.loopodo.gradienttablayout.listener.OnTabSelectListener;
import com.loopodo.gradienttablayout.widget.MsgView;
import com.loopodo.samples.R;
import com.loopodo.samples.utils.ViewFindUtils;
...
public class SlidingTabActivity extends AppCompatActivity implements OnTabSelectListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //渐变底部导航
        final SlidingTabLayout tabLayout_12 = ViewFindUtils.find(decorView, R.id.tl_12);
        ...
        tabLayout_12.showDot(1);

        tabLayout_12.setOnTabSelectListener(new OnTabSelectListener() {
            @Override
            public void onTabSelect(int position) {
                tabLayout_12.setTextSizeTest(7,10,position);
            }
