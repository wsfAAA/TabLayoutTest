...
import com.loopodo.gradienttablayout.CommonTabLayout;
...
import com.loopodo.samples.entity.TabEntity;
...
public class CommonTabActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTabLayout_9.setOnTabSelectListener(new OnTabSelectListener() {
            @Override
