package com.loopodo.gradienttablayout;
...
import com.loopodo.gradienttablayout.listener.CustomTabEntity;
import com.loopodo.gradienttablayout.listener.OnTabSelectListener;
import com.loopodo.gradienttablayout.utils.FragmentChangeManager;
import com.loopodo.gradienttablayout.utils.UnreadMsgUtils;
import com.loopodo.gradienttablayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static final int COLOR_TOPBOTTOM = 1;
    private static final int COLOR_LEFTRIGHT = 2;
    ...
    private int mIndicatorColorStyle = COLOR_NORMAL;
    ...
    private void obtainAttributes(Context context, AttributeSet attrs) {
        ...
        mIndicatorColorStyle = ta.getInt(R.styleable.CommonTabLayout_tl_indicator_color_style, 0);
        ...
        mIndicatorStartColor = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_start_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        mIndicatorEndColor = ta.getColor(R.styleable.CommonTabLayout_tl_indicator_end_color, Color.parseColor(mIndicatorStyle == STYLE_BLOCK ? "#4B6A87" : "#ffffff"));
        ...
        mIndicatorCornerRadius = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_corner_radius, dp2px(mIndicatorStyle == STYLE_BLOCK ? 0 : 0));
        mIndicatorMarginLeft = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_left, dp2px(0));
        mIndicatorMarginTop = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_top, dp2px(mIndicatorStyle == STYLE_BLOCK ? 0 : 0));
        mIndicatorMarginRight = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_right, dp2px(0));
        mIndicatorMarginBottom = ta.getDimension(R.styleable.CommonTabLayout_tl_indicator_margin_bottom, dp2px(mIndicatorStyle == STYLE_BLOCK ? 0 : 0));
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    ...
                    Log.e("wsf", "count:  " + mTabCount + "    pos:  " + position);
                } else {
                    if (mListener != null) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIndicatorStyle == STYLE_TRIANGLE) {
            if (mIndicatorHeight > 0) {
                mTrianglePaint.setColorFilter(new ColorFilter());
                mTrianglePath.reset();
            ...
            if (mIndicatorHeight > 0) {
                ...
                if (mIndicatorColorStyle == COLOR_NORMAL) {
                    mIndicatorDrawable = new GradientDrawable();
                    mIndicatorDrawable.setColor(mIndicatorColor);
                } else if (mIndicatorColorStyle == COLOR_TOPBOTTOM) {
                    int colors[] = {mIndicatorStartColor, mIndicatorEndColor};
                    mIndicatorDrawable = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM, colors);
                } else {
                    int colors[] = {mIndicatorStartColor, mIndicatorEndColor};
    ...
    public void setIndicatorStartColor(int indicatorStartColor) {
        mIndicatorStartColor = indicatorStartColor;
        invalidate();
    }
    ...
    public void setIndicatorEndColor(int indicatorEndColor) {
        mIndicatorEndColor = indicatorEndColor;
        invalidate();
    }

    public int getIndicatorColorStyle() {
        return mIndicatorColorStyle;
    }

    public void setIndicatorColorStyle(int indicatorColorStyle) {
        mIndicatorColorStyle = indicatorColorStyle;
        invalidate();
    }
